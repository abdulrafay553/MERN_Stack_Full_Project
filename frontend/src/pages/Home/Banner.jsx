      ...
      <div className="flex flex-col md:flex-row-reverse justify-between items-center gap-12 py-40">
        ...
        <div className="md:w-1/2 space-y-8 bg-teal-100">
          ...
          <p>
            ...
            lovers on Goodreads. From classics to contemporary bestsellers, This
            is your go-to destination for literary exploration. Our shelves are
            filled with stories waiting to be discovered, enjoyed, and shared.
          </p>
        </div>
      </div>
    </div>
